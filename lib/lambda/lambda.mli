...
type primitive =
  ...
  | PrimitiveAddFloat            (** Float addition *)
  | PrimitiveSubFloat            (** Float subtraction *)
  | PrimitiveMulFloat            (** Float multiplication *)
  | PrimitiveDivFloat            (** Float division *)
  | PrimitiveNegFloat            (** Float negation *)
