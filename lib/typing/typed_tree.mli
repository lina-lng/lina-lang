...
and typed_expression_desc =
  ...
  | TypedExpressionModuleAccess of Module_types.path * string
...
and typed_structure_item_desc =
  ...
  | TypedStructureOpen of Module_types.path * (string * Common.Identifier.t) list
  | TypedStructureInclude of typed_module_expression * (string * Common.Identifier.t) list
