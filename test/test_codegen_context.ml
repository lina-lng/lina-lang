...
|} in
  ...
  [%expect {|
    ...
    local r_12 = _Ctor_color_0
    local g_13 = _Ctor_color_1
    local b_14 = _Ctor_color_2
    |}]
...
|} in
  ...
  [%expect {|
    local _Ctor_option_0 = {_tag = 0}
    local a_15 = _Ctor_option_0
    local b_16 = _Ctor_option_0
    local c_17 = _Ctor_option_0
    |}]
...
|} in
  let lua = compile code in
  print_endline lua;
  [%expect {| local x_18 = {_tag = 1, _0 = 42} |}]
